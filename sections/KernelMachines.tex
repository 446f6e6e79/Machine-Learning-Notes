...
mantaining the same underlying principles of SVMs (large margin and theoretical guarantees).
...
\\In the \textbf{dual formulation} of SVMs, the data points appear only in the form of \textbf{dot products} 
...
\]
\[
    = (x_1 x_1')^2 + 2 x_1 x_2 x_1' x_2' + (x_2 x_2')^2 + 2 x_1 x_1' + 2 x_2 x_2' + 1
\]
...
\end{itemize}
\begin{comment}
    #TODO: add example on support vector regression??
\end{comment}

...
\end{table}
The dataset is already sorted according to attribute A. The candidate tresholds are:
\begin{itemize}
    \item Between example 2 and 3: (3.0 + 4.5) / 2 = 3.75;
    \item Between example 4 and 5: (5.0 + 6.0) / 2 = 5.5;
\end{itemize}
We can then compute the IG for both tresholds, choosing the one with the highest value.

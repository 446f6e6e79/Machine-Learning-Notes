...
\begin{comment}
    #TODO: maybe add example exercises here??
\end{comment}
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Node $E$ is in a head to tail connection and is not observed. One of is child ($C$) is observed, meaning

...
To estimate the performance of a learning algorithm, we need to evaluate it on data that has not been used for training.
...
\begin{itemize}
	...
	\item \textbf{Compute score} $S$ of the \textbf{predictor} $\mathcal{L}(T_i)$:

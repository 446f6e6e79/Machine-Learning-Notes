...
\subsection{Probabilistic reasoning}: reasoning in presence of uncertainty. It can be used for:
\begin{itemize}
...
\begin{itemize}
    ...
    Once learned, we can use \textbf{generative methods} to model the distribution;

...
A discrete CDP $P(X_j | Pa_j)$ can be represented as a table:
\begin{itemize}
    ...
    \item Each table entry $\theta_{x_j|pa_j}$ represents the probability of the configuration $X_j = x_j$ and $Pa_j = pa_j$.
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item if $X_i(l)$ or $Pa_i(l)$ are observed for $X_l$ in the dataset $\mathcal{D}$, then the probability is either 0 or 1;

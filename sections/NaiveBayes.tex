\section{Naive Bayes}
Nayve Bayes is a simple classification algorithm based on Bayesian networks.
\paragraph{Setting}
\begin{itemize}
...
\end{equation}
We assume that each attribute $A_j$ is modeled using the same type of distribution.
